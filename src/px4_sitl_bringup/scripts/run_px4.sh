...
LIDAR_RVIZ_SCRIPT="${LIDAR_RVIZ_SCRIPT:-$package_share/scripts/internal/run_lidar_rviz.sh}"
X500_TF_SCRIPT="${X500_TF_SCRIPT:-$package_share/scripts/internal/run_x500_tf.sh}"
